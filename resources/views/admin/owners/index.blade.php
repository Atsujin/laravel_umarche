      ...
      <table class="table-auto w-full text-left whitespace-no-wrap">
        ...
        @foreach ($owners as $owner)
          <tr>
            ...
            <button onclick="location.href='{{ route('admin.owners.edit', ['owner' => $owner->id])}}'" class="text-white bg-green-500 border-0 py-2 px-4 focus:outline-none hover:bg-green-600 rounded text-lg">編集</button>
            </td>
